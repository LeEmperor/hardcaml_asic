#!/usr/bin/env python3
"""Development adapter: the P6.1 reporter lives in `hardcaml_asic_flow`.

Installed as `hardcaml-asic-flow report`. See
`flow/hardcaml_asic_flow/report.py`; acceptance policy is entirely there.
"""
