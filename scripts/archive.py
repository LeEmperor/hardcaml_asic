#!/usr/bin/env python3
"""Development adapter: the P6.2 archiver lives in `hardcaml_asic_flow`.

Installed as `hardcaml-asic-flow archive`. See
`flow/hardcaml_asic_flow/archive.py`; selection, verification and publication
policy is entirely there.
"""
